...
**Step 1: Add orphaned_assets to eval workflow**

Append to existing suite run list (keep deterministic ordering).

**Step 2: Verify workflow format**

Run: `python3 -m yaml .github/workflows/eval.yml` (or equivalent lint if available)
